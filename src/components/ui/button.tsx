  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-hero text-primary-foreground hover:shadow-xl transform hover:scale-105 transition-bounce text-base font-semibold",
        ...
        publisher: "bg-role-publisher text-role-publisher-foreground hover:bg-role-publisher/90 shadow-md",
        author: "bg-role-author text-role-author-foreground hover:bg-role-author/90 shadow-md",
        vendor: "bg-role-vendor text-role-vendor-foreground hover:bg-role-vendor/90 shadow-md",
        student: "bg-role-student text-role-student-foreground hover:bg-role-student/90 shadow-md",
      },
      size: {
